...
/**
 * Description:
 * GPS_Point class implements the GIS_element interface.
 * the class represents a line from a csv file and contains the fields presented in the csv excel
 * in addition to one more field GPS_data.
 * 
...
public class GPS_Point implements GIS_element{
	...
	/**
	 * Description:
	 * method inherited from Geom-element interface
	 * the method create a 3D point from the relevant fields
	 * 
	 * @return Point3D
	 */
