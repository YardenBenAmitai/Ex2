...
/**
 * Description:
 * MyCoords class implements the coords_converter interface.
 * the class performs various calculations with 3d points.
 * 
...
public class MyCoords implements coords_converter {
	...
	/** 
	 * Description:
	 * the method computes a new point which is the gps point transformed by a 3D vector (in meters)
	 * 
	 * @param gps
	 ...
	 * source :https://www.codeguru.com/cpp/cpp/algorithms/article.php/c5115/Geographic-Distance-and-Azimuth-Calculations.htm
	 */
	 ...
	 * this method return an azimuth (aka yaw), elevation (pitch), and distance
	 */
