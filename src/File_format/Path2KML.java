	...
	public StringBuilder createPath(Path path){
		 StringBuilder strB = new StringBuilder(); //string builder is mutable 
	        ...
	        for (Fruit f: path.getPath()){
	            ...
	            strB.append("<name>" + f.getData().getID() + " </name>" + "\n");
	            ...
	            strB.append("</TimeStamp>" + "\n");
	            strB.append("<Point>" + "\n");
	            strB.append("<coordinates>" + f.getData().get_Orientation().x() + "," + f.getData().get_Orientation().y() + "," + f.getData().get_Orientation().z() + "</coordinates>");
	            strB.append("</Point>" + "\n");
	            strB.append("</Placemark>" + "\n");
	        }
	       return strB;
